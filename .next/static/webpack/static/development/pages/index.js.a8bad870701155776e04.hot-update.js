...
function Marketing() {
  return __jsx(StyledMarketing, null, __jsx("section", {
    ...
    span: [8]
  }, __jsx("h2", null, "Highway"), __jsx("h1", null, "Get It Your Way"), __jsx("p", null, "Find your perfect kit and let us take care of logisitcs."), __jsx("label", {
    className: "hero__input"
  }, __jsx("input", {
    type: "email",
    placeholder: "name@email.com"
  }), __jsx("button", null, __jsx("span", null, "Join the waitlist."))), __jsx("p", {
    ...
    span: [12, 5]
  }, __jsx("h3", null, "Flowers Or Vapor"), __jsx("p", {
    className: "small"
...
//# sourceMappingURL=index.js.a8bad870701155776e04.hot-update.js.map